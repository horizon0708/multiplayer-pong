...
var GameServerOld = /** @class */ (function () {
    function GameServerOld(server) {
        this.players = [];
        this.server = server;
    ...
    GameServerOld.prototype.start = function () {
        this.simulation.start();
    };
    GameServerOld.prototype.listen = function () {
        var _this = this;
